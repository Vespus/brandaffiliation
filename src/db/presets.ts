...
import { aiModels, aiProviders, aiSettingsDefault, aiSettingsUser } from '@/db/schema'
...
export const getAIModelsWithProviderAndSettings = async (
    models: number[]
): Promise<AIModelWithProviderAndSettings[]> => {
