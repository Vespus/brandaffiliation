...
export const aiSettingsUser = pgTable(
    'ai_settings_user',
    {
        id: serial().primaryKey().notNull(),
        userId: uuid('user_id'),
...
export const aiProviders = pgTable(
    ...
    (table) => [unique('ai_providers_code_key').on(table.code)]
)
...
export const systemPrompts = pgTable(
    ...
    (tbl) => [unique('system_prompts_name_key').on(tbl.name)]
)
