                    ...
                    <div className="space-y-4 p-4 bg-white rounded-lg shadow">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center space-x-2">
                                <div
                                    className={`w-3 h-3 rounded-full ${settings.apiKeys?.openai ? 'bg-green-500' : 'bg-red-500'}`}/>
                                <span>OpenAI API Key: {settings.apiKeys?.openai ? 'Verfügbar' : 'Nicht verfügbar'}</span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <div
                                    className={`w-3 h-3 rounded-full ${settings.apiKeys?.anthropic ? 'bg-green-500' : 'bg-red-500'}`}/>
