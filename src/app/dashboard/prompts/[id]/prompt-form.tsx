...
import type { PromptFormData } from '@/app/dashboard/prompts/actions'
...
import { z } from 'zod'
import { createPrompt, updatePrompt } from '@/app/dashboard/prompts/actions'
...
export function PromptForm({ prompt }: PromptFormProps) {
    ...
    async function onSubmit(data: PromptFormData) {
        ...
        try {
            const result = prompt ? await updatePrompt(prompt.id, data) : await createPrompt(data)
