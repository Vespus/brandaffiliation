                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="flex items-center justify-between">
                                        ...
                                        <span>
                                            {similarityWeight[0] * 100}% / {similarityWeight[1] * 100}%
                                        </span>
                                    </FormLabel>
                                    <FormControl>
                                        <Slider
                        ...
                        <p className="text-right text-xs">
                            Current sum:{' '}
                            <span className={totalSum > 1.0 ? 'font-bold text-red-500' : 'font-bold text-green-500'}>
                                {formattedSum}
                            </span>
                        </p>
                        <div className="flex gap-2">
                            ...
                            <Button type="submit" className="flex-1" disabled={totalSum > 1.0}>
                                Apply Weights
                            </Button>
                        </div>
                    </form>
