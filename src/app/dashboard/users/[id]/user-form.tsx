        ...
        if (data.banned) {
            await authClient.admin.banUser({
                ...
                banExpiresIn: data.banExpiresIn
                    ? differenceInSeconds(fromUnixTime(data.banExpiresIn!), new Date())
                    : undefined,
            })
            ...
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>You can change user&apos;s role here</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>Ban reason is required if ban user is checked</FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>Ban expire is required if ban user is checked</FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                        ...
                        <hr className="my-4" />
                        <Button className="self-end" loading={loading}>
                            Update User
                        </Button>
                    </form>
                </Form>
