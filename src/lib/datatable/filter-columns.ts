import type { ExtendedColumnFilter, JoinOperator } from '@/lib/datatable/types/data-table'
import type { AnyColumn, SQL, Table } from 'drizzle-orm'

import { addDays, endOfDay, startOfDay } from 'date-fns'
import { and, eq, gt, gte, ilike, inArray, lt, lte, ne, not, notIlike, notInArray, or } from 'drizzle-orm'
        ...
        switch (filter.operator) {
            ...
            case 'isBetween':
                ...
                if (
                    ...
                    const firstValue = filter.value[0] && filter.value[0].trim() !== '' ? Number(filter.value[0]) : null
                    const secondValue =
