        ...
        <div className="relative inline-flex">
            ...
            {previewUrl && (
                <Button
                    ...
                    size="icon"
                    className="border-background focus-visible:border-background absolute -top-1 -right-1 z-20 size-6 rounded-full border-2 shadow-none"
            ...
            {loading && (
                <div className="absolute inset-0 z-10 flex items-center justify-center rounded-full bg-black/50 backdrop-blur-2xl">
                    <Loader data-loader={true} className="origin-center animate-spin" aria-hidden="true" />
                </div>
            )}
