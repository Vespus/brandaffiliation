...
export function getBranchTableColumns(): ColumnDef<BrandWithCharacteristicAndScales>[] {
    return [
        ...
        },
        {
            ...
            header: ({ column }) => <DataTableColumnHeader column={column} title="Charakteristik" />,
            cell: ({ row }) => {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.price || 0} scale="price" />
            },
            meta: {
                label: 'scale.price',
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.quality || 0} scale="quality" />
            },
            meta: {
                label: 'scale.quality',
                labelHasTranslation: true,
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.design || 0} scale="design" />
            },
            meta: {
                label: 'scale.design',
                labelHasTranslation: true,
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.focus || 0} scale="focus" />
            },
            meta: {
                label: 'scale.focus',
                labelHasTranslation: true,
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.positioning || 0} scale="positioning" />
            },
            meta: {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.recognition || 0} scale="recognition" />
            },
            meta: {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.heritage || 0} scale="heritage" />
            },
            meta: {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.origin || 0} scale="origin" />
            },
            meta: {
                label: 'scale.origin',
                labelHasTranslation: true,
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <SimpleRating value={row.original.revenue || 0} scale="revenue" />
            },
            meta: {
                label: 'scale.revenue',
                labelHasTranslation: true,
