    ...
    return (
        <div className="flex w-full flex-none flex-col gap-0 xl:max-w-xl min-h-0 py-4 pr-4">
            <div className="flex-none ">
                <h1 className="text-lg font-semibold">Brand Content Studio</h1>
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            <div className="flex flex-row items-center gap-2">
                                                ...
                                                <FormLabel>Use brand characteristics and scales if matched</FormLabel>
                                            </div>
                                            <FormDescription className="text-xs">If a QSPay brand matched in
                                                Brandaffiliation, system will
                                                append their Brandaffiliation data to enrich the
