...
import { useContentGenerationQueryParams } from '@/app/dashboard/content-generation/use-content-generation-query-params'
...
export const TemporaryStudio = () => {
    ...
    return (
        <div className="flex flex-1 flex-col">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {(selectedBrand || selectedCategory) && (
                        <div className="text-xs">
                            ...
                            <a href={possibleUrl} className="inline-flex gap-2" target="_blank">
                                <span>{possibleUrl}</span>
                                <ExternalLinkIcon size={12} className="size-auto" />
                            </a>
                        </div>
                    )}
                </div>
            ...
            <div className="flex flex-1 items-center px-12 py-4">
                    ...
                    <CarouselContent className="-ml-4">
                        {Object.entries(state.streams).map(([modelId, stream]) => (
                            <CarouselItem className="basis-1 pl-4 lg:basis-1/2 2xl:basis-1/3" key={modelId}>
                                <div className="p-1">
                                    <BaseNode>
                                        <div className="bg-muted -mx-5 -mt-5 mb-4 flex flex-col rounded-t-md p-5">
                                        ...
                                        <Scroller className="max-h-[400px] space-y-6">
                                            <div>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex flex-col space-y-1">
                                                        ...
                                                        <p className="text-muted-foreground text-xs">
                                                            {stream.stream?.meta?.title}
                                                        </p>
                                                    </div>
                                                    <div className="flex flex-col space-y-1">
                                                        <h3 className="text-xs font-medium">Description:</h3>
                                                        <p className="text-muted-foreground text-xs">
                                                            {stream.stream?.meta?.description}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex flex-col space-y-1">
                                                        <h3 className="text-xs font-medium">
                                                            Hero Header (Page Header Content):
                                                        </h3>
                                                        <div
                                                            className="text-muted-foreground prose prose-sm dark:prose-invert text-xs [&>h1]:text-xs"
                                                            dangerouslySetInnerHTML={{
                                                                __html: stream.stream?.descriptions?.header,
                                                            }}
                                                        ></div>
                                                    </div>
                                                    <div className="flex flex-col space-y-1">
                                                        <h3 className="text-xs font-medium">
                                                            Hero Footer (Page Bottom Content):
                                                        </h3>
                                                        <div
                                                            className="text-muted-foreground prose prose-sm dark:prose-invert text-xs [&>h1]:text-xs"
                                                            dangerouslySetInnerHTML={{
                                                                __html: stream.stream?.descriptions?.footer,
                                                            }}
                                                        ></div>
                                                    </div>
                                                </div>
